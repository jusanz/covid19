<template>
  <v-app class="app">
    <v-overlay v-if="loading" color="#F8F9FA" opacity="1" z-index="9999">
      <div class="loader">
        <img src="/logo.svg" alt="Code4Kochi" />
  ...
  head(): MetaInfo {
    ...
    return {
      ...
      link: [
        {
          rel: 'canonical',
          href: `https://stopcovid19.code4kochi.com${this.$route.path}`
        },
        {
          rel: 'stylesheet',
      ...
      meta: [
        {
          hid: 'author',
          name: 'author',
          content: this.$tc('Code4Kochi')
        },
        {
          hid: 'description',
          name: 'description',
          content: this.$tc(
            '当サイトは新型コロナウイルス感染症 (COVID-19) に関する情報を提供するために、Code4Kochiが開設したものです。'
          )
        },
        {
          hid: 'og:site_name',
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: `https://stopcovid19.code4kochi.com${this.$route.path}`
        },
        {
          hid: 'og:locale',
          property: 'og:locale',
